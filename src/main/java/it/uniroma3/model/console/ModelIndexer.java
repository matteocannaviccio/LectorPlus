...
public class ModelIndexer {
    ...
    public enum IndexType {phrases, relations, typedphrases, types, phrases2relations, 
	phrases2typedrelations, typedphrases2relations, relations2typedphrases, types2relations};
	...
	public ModelIndexer(String folderIndex, int PERCENTAGE){
	    ...
	    String phrase2typedrelationIndexPath = folder.getAbsolutePath() + "/" + phrase2typedrelationPATH;
	    String typedphrase2relationIndexPath = folder.getAbsolutePath() + "/" + typedphrase2relationPATH;
	    String types2relationIndexPath = folder.getAbsolutePath() + "/" + types2relationPATH;
	    String relations2typedphraseIndexPath = folder.getAbsolutePath() + "/" + relation2typedphrasePATH;
		...
		CounterMap<String> filtered_triples = Lector.getDbmodel(false).retrieveEvidence("model_triples", 5, PERCENTAGE);
		Lector.close();
		
		this.createIndexes(filtered_triples, phrasesIndexPath, relationsIndexPath, typedphrasesIndexPath,
			typesIndexPath, phrase2relationIndexPath, phrase2typedrelationIndexPath, typedphrase2relationIndexPath, 
			types2relationIndexPath, relations2typedphraseIndexPath);
	    }
	 ...
	 * @return
	 */
	private void createIndexes(CounterMap<String> everything, String phrasesIndexPath, String relationsIndexPath, 
		String typedphrasesIndexPath, String typesIndexPath, String phrase2relationIndexPath, 
		String phrase2typedrelationIndexPath, String typedphrase2relationIndexPath, String types2relationIndexPath,
