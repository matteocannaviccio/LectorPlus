...
public class ModelNaiveBayesFilterSpy extends ModelNaiveBayes {
     ...
     */
    public ModelNaiveBayesFilterSpy(DBLector db_model, String evidence_table, int minF, ModelType modelType, double majorityThreshold) {
	...
	if (!prediction.getKey().equals("UNKNOWN") && !prediction.getKey().equals("MAJRUL") && !prediction.getKey().equals("NONE")){
