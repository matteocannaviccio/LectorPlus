...
public class WikiTriple {
  ...
  public enum TType {
    MVL, JOINABLE, JOINABLE_NOTYPE_BOTH, JOINABLE_NOTYPE_SBJ, JOINABLE_NOTYPE_OBJ, DROP
  }
   ...
   * @param articleType
   */
  public WikiTriple(String wikid, String section, String wholeSentence, String phrase_original,
      String phrase_placeholders, String pre, String post, String subject, String object,
  ...
  /**
   * Reg-ex that defines primary (PE) o secondary entities (SE) that have a wikid and a specific
   * type.
   * 
  ...
  /**
   * This method queries the KG to find possible relations between the entities. We use the method
   * only if a triple is JOINABLE.
   * 
   * @return
   */
  ...
  /**
   * This method queries the Types Assigner to find the type for the entities. It assigns [none] in
   * case of no type.
   * 
   * @return
   */
  ...
  public String toString() {
    return this.subject + this.subjectType + "\t" + this.phrase_placeholders + "\t" + this.object
        + this.objectType;
  }
