...
public class Triplifier {
	...
	System.out.println("\t # (labeled expanded triples: " + withSuffix(fromWhichLabeledExpanded.intValue()) + ")");
	System.out.println("\t # unlabeled triples: " + withSuffix(fromWhichUnlabeled.intValue()));
	System.out.println();
	System.out.println("\t # eliminated: " + withSuffix(conjuctionCount.intValue() + specialCharCount.intValue() + possessiveCount.intValue() + largeSentencesCount.intValue()));
	System.out.println("\t # triples with conjuctions (and, commas, etc.): " + withSuffix(conjuctionCount.intValue()));
	System.out.println("\t # triples with special chars ((, ), ;, :, etc.):  " + withSuffix(specialCharCount.intValue()));
	System.out.println("\t # triples with possessive after the object ('s): " + withSuffix(possessiveCount.intValue()));
	System.out.println("\t # triples too large (>15 tokens): " + withSuffix(largeSentencesCount.intValue()));
	System.out.println("");
