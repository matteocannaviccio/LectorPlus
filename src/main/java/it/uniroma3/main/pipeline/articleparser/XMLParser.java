...
public class XMLParser {
  ...
  /**
   * Parse the XML and returns the content of the field given as a parameter. E.g. <title> content
   * </title>, <id> content </id>, <ns> content </ns>
   * 
   * @param content
   * @param field
   * @return
  ...
  public String getFieldFromXmlPage(String content, String field) {
    ...
    return StringEscapeUtils
        .unescapeHtml4(content.substring(start + XML_START_TAG_FIELD.length(), end));
  }

  /**
   * Parse the XML and returns the real content, inside the "text" field. We differentiate it only
   * because of the different regex (to improve).
   * 
