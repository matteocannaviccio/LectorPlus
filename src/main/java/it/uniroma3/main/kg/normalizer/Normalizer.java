...
public class Normalizer {
  ...
  /**
   * It iterated two times over the rdf dump in order to normalize "functional nodes". For example,
   * some occupations of people are expressed with functional nodes such as:
   * http://dbpedia.org/page/Allan_Dwan__1.
   * 
   * The method removes those nodes and normalize them replacing with the relative object (if it is
   * a entity) or eliminating the triple if it is a literal.
   * 
   * @return
   */
