...
public class Main {
	...
	Pipeline cp = new Pipeline(Configuration.getOriginalArticlesFile(), Configuration.getParsedArticlesFile(), Configuration.getAugmentedArticlesFile());
	cp.runPipeline(Configuration.getNumArticlesToProcess(), Configuration.getChunkSize(), Configuration.getPipelineSteps());
